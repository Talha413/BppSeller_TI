...
class AllYoursPage extends StatelessWidget {
  const AllYoursPage({super.key});
        ...
        children: [
          Container(
            ...
            child: Row(
              ...
              children: [
                Text("All Yours", style: TextStyle(fontSize: 14.sp)),
                // Container(
                //   height: 20.h,
                //   width: 110.w,
                //   //color: Colors.blue,
          ...
          Container(
            ...
            child: GridView.builder(
              ...
              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                crossAxisCount: 2,
                mainAxisExtent: 322.h, // number of items in each row
